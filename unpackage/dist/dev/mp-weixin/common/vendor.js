...
let m;
m = g;
const y = f('{\n    "address": [\n        "127.0.0.1",\n        "192.168.31.44"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/SoftWare/HBuilderX.3.6.5.20221121/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), _ = f('[{"provider":"aliyun","spaceName":"money-man-space","spaceId":"mp-b5d9a4b4-f2d9-4965-9c22-925808f59206","clientSecret":"I5bhpCxC4ksDhqlqAIbuxQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let v = "";
try {
  v = "__UNI__EE06F9D";
} catch (e2) {
